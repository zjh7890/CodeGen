...
import me.lotabout.codegenerator.ui.GetInputPane;
        ...
        for (PipelineStep step : codeTemplate.pipeline) {
            ...
            switch (step.type()) {
                ...
                case "member-selection":
                    ...
                    break;
                case "text-input":
                    GetInputPane getInputPane = new GetInputPane(null);
                    getInputPane.showAndGet();
                    String text = getInputPane.textField1.getText();
                    contextMap.put("input" + step.postfix(), text);
                    break;
                default:
